...
public class RestaurantController {
  ...
  public static final String RESTAURANT_API_URI = RESTAURANT_API_ENDPOINT + RESTAURANTS_API;
  ...
  @GetMapping(RESTAURANT_API_URI)
  public ResponseEntity<GetRestaurantsResponse> getHttpStatusCode(@Valid GetRestaurantsRequest getRestaurantsRequest) {
    log.info("getRestaurants called with {}", getRestaurantsRequest);
    GetRestaurantsResponse getRestaurantsResponse;
