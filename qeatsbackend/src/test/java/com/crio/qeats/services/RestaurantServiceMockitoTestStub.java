...
public class RestaurantServiceMockitoTestStub {
  ...
  public void  testFindNearbyWithin5km() throws IOException {
    ...
    when(restaurantRepositoryServiceMock.findAllRestaurantsCloseBy(any(Double.class), any(Double.class), eq(LocalTime.of(3, 0)), eq(5.0)))
          .thenReturn(Arrays.asList(restaurant1, restaurant2));
    GetRestaurantsResponse allRestaurantsCloseBy = restaurantService.findAllRestaurantsCloseBy(new GetRestaurantsRequest(20.0, 30.0),
    LocalTime.of(3, 0));
  ...
  public void  testFindNearbyWithin3km() throws IOException {
    ...
    allRestaurantsCloseByOffPeakHours = restaurantService.findAllRestaurantsCloseBy(new GetRestaurantsRequest(20, 30.2), LocalTime.of(3,0));
